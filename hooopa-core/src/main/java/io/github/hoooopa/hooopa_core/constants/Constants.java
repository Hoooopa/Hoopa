package io.github.hoooopa.hooopa_core.constants;
...
public class Constants {
     ...
     * 用于保存是否是第一次安装
     */
    public static String SHARED_PEREFERENCE_FIRST_INSTALL_APP = "FirstInstall";

    public static String FIRST_INSTALL = "First_Install";


    /**
     * 京东万象数据的Appkey和BaseUrl
     */
     ...
     * 豆瓣API的BaseUrl
     */
    public static final String DOUBAN_API_BASE_URL = "http://api.douban.com/v2/movie/";
