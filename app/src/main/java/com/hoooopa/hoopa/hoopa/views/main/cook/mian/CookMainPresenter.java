...
import com.hoooopa.hoopa.hoopa.views.main.cook.CookModel;
import com.hoooopa.hoopa.hoopa.views.main.cook.ICookCallback;
...
public class CookMainPresenter extends BasePresenter<ICookView.ICookMainView> {

    private ICookView.ICookMainView view;

    public CookMainPresenter(ICookView.ICookMainView view){
        this.view = view;
    }
    ...
    public void getBannerData(){
        ...
        new CookModel().getCookDataByClassid(getRandomClassid() , getRandomStart() ,6 , new ICookCallback.ICookMainCallback.CookDataByClassidCallback() {
            @Override
    ...
    public void getRcvData(int start){
        ...
        new CookModel().getCookDataByClassid(getRandomClassid(), start, 10, new ICookCallback.ICookMainCallback.CookDataByClassidCallback() {
            @Override
