...
public class DoubanModel {
    ...
    public void getBannerData(int count, final IDoubanCallback.BannerCallback callback){
    ...
    public void getComingData(int count,final IDoubanCallback.ComingCallback callback){
        retrofit.create(HttpClient.class)
    ...
    public void getTop250Data(int start, int count ,final IDoubanCallback.Top250Callback callback){
        retrofit.create(HttpClient.class)
    ...
    public void getUsBoxData(final IDoubanCallback.UsBoxCallback callback){
        retrofit.create(HttpClient.class)
                .getMovieUsBox()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
